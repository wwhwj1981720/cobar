...
public class CobarServer {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(CobarServer.class);
    ...
    public void beforeStart(String dateFormat) {
        ...
        if(home == null) {
        	...
        	System.setProperty("cobar.home", home);
        }
        if (home == null) {
            SimpleDateFormat sdf = new SimpleDateFormat(dateFormat);
            LOGGER.warn(sdf.format(new Date()) + " [cobar.home] is not set.");
        } else {
